...
function pal(id, name, color, bgcolor, boxshadow, avatar, mood, favorite_sounds, favorite_bpms, favorite_genres, phrases) {
    this.id = id;
    this.name = name;
    this.color = color;
...
const Darko = new pal(1, 'Darko', 'rgb(177, 190, 197, 1)','linear-gradient(0.1turn, #fff, #bcbcbc, #333)' , 'inset 1px 7px 39px 44px rgb(0 0 0)','images/Darko.jpg', 'dark', ['low frequency sound', 'dark sound',
...
const Ramos = new pal(2, 'Ramos', 'rgb(243 136 116 / 92%)','linear-gradient(0.7turn, #e7ff703b, #fff28d, #ddd3bb94)', 'inset 0px 3px 29px 14px rgb(0 0 0 / 43%)', 'images/Ramos.jpeg', 'fiesta', ['bright sound', 'horn stab',
