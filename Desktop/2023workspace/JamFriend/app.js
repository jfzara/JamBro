...
function pal(id, name, color, bgcolor, avatar, mood, favorite_sounds, favorite_bpms, favorite_genres, phrases) {
    this.id = id;
    this.name = name;
    this.color = color;
...
const Darko = new pal(1, 'Darko', 'rgb(177, 190, 197, 1)','45deg, rgb(241 237 237), rgb(236 230 183 / 52%), rgb(171 151 151 / 45%),' ,'images/Darko.jpg', 'dark', ['low frequency sound', 'dark sound',
...
const Ramos = new pal(2, 'Ramos', 'rgb(244, 255, 41, 1)','45deg, rgb(241 237 237), rgb(236 230 183 / 52%), rgb(171 151 151 / 45%),', 'images/Ramos.jpeg', 'fiesta', ['bright sound', 'horn stab',
