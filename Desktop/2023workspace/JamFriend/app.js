...
const Darko = new pal(1, 'Darko', 'rgb(222 211 237)','linear-gradient(0.1turn, #fff, #bcbcbc, #333)' , 'inset 2px 2px 33px 28px rgb(0 0 0 / 57%)','images/Darko.jpg', 'dark', ['low frequency sound', 'dark sound',
...
const Ramos = new pal(2, 'Ramos', 'rgb(246 86 56 / 92%)','linear-gradient(0.7turn, #e7ff703b, #fff28d, #ddd3bb94)', 'inset 0px 3px 29px 14px rgb(0 0 0 / 43%)', 'images/Ramos.jpeg', 'fiesta', ['bright sound', 'horn stab',
