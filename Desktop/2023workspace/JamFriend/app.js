...
const Darko = new pal(1, 'Darko', 'rgb(177, 190, 197, 1)','linear-gradient(to left, #333, #333 50%, #eee 7%, #333 75%)' ,'images/Darko.jpg', 'dark', ['low frequency sound', 'dark sound',
...
const Ramos = new pal(2, 'Ramos', 'rgb(244, 255, 41, 1)','linear-gradient(0.25turn, #d8f25947, #fbffd1, #ddd3bb94)', 'images/Ramos.jpeg', 'fiesta', ['bright sound', 'horn stab',
