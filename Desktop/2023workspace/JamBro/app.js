...
const Darko = new pal(1, 'Darko', 'black', 'avatarDarko', 'dark', ['low frequency sound', 'dark sound',
...
const Ramos = new pal(2, 'Ramos', 'red', 'avatarRamos', 'fiesta', ['bright sound', 'horn stab',
